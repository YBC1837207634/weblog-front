      ...
      <div class="items">
        ...
        <div class="right-items">
          ...
          <div class="message-item">
            <icon-notification style="font-size: 16px" @click="notificationHandler" />
          </div>
          <div class="avatar">
            <div class="btn" v-if="userStore.isLogin">
              <a-avatar @click="userSpace" :size="40" v-if="userStore.getUser.avatar">
                <img alt="avatar" :src="setting.baseUrl + userStore.getUser.avatar" />
              </a-avatar>
              <a-avatar @click="userSpace" :size="40" v-else> U </a-avatar>
            </div>
    ...
    <div class="mask" v-if="menuVisible" @click="menuVisible = false">
      ...
      <div class="float-menu">
        <a-menu
          ...
          :default-selected-keys="[$route.path]"
          :selected-keys="[$route.path]"
          :style="{ width: '50vw', height: '100vh', 'backgroud-color': '#232324' }"
          @menu-item-click="go"
        >
