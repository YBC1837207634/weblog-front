  ...
  <a-form ref="formRef" :size="'large'" :model="form" @submit-success="handleSubmitSuccess">
    <a-form-item
      ...
      :rules="[
        ...
        { minLength: 2, message: '不可小于2个字符' },
        { maxLength: 100, message: '不可以超过100' }
      ]"
    >
    ...
    <a-form-item
      ...
      label="手机号"
      :rules="[
        { minLength: 11, message: '不可小于11个字符' },
        { maxLength: 11, message: '不可以超过11' }
      ]"
    >
    ...
    <a-form-item
      ...
      :rules="[
        { minLength: 2, message: '不可小于2个字符' },
        { maxLength: 128, message: '不可以超过128' }
      ]"
    >
    ...
    <a-form-item
      field="description"
      label="个性签名"
      :rules="[{ maxLength: 255, message: '不可以超过255' }]"
    >
      <a-textarea
